...
const Contact = () => {
  return (
    <section id="contact" className="mih-h flex items-center justify-center">
      <RevealOnScroll>
        <div className="px-4 w-150">
          <h2 className="text-3xl font-bold mb-8 bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent text-center">
            Get In Touch
          </h2>
          <span>LinkedIn Account <a href="https://www.linkedin.com/in/homer-garnet-cabilla/" className="text-blue-500">https://www.linkedin.com/in/homer-garnet-cabilla/</a></span>
